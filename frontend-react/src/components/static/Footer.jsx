        ...
        <Grid item xs={12} sm>
          ...
          <ul style={{listStyleType:'none', padding:'0.5rem'}}>
            ...
            <Divider />
              ...
              <Typography gutterBottom variant="subtitle1">Tens alguma questão?</Typography>
              <Typography gutterBottom variant="body2">
                <InboxIcon style={{marginRight: '1rem'}} fontSize="small" /> bobapostas@gmail.com
              </Typography>
            </li>
            <Divider />
            <li>
              <Typography gutterBottom variant="body1">Horas de apostas</Typography>
              <Typography  gutterBottom variant="body2"><QueryBuilderOutlinedIcon style={{marginRight: '1rem'}} fontSize="small"/> 15-17h</Typography>
            </li>
          </ul>
        </Grid>
        {/* <Grid item xs={12} sm>
